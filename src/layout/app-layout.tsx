...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'trainer', 'member'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Exercises', path: '/exercises', entity: 'exercise', service: AccessServiceEnum.PROJECT, icon: FiActivity },
    {
    ...
    { name: 'Workouts', path: '/workouts', entity: 'workout', service: AccessServiceEnum.PROJECT, icon: FiHeart },
    {
