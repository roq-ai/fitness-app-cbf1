...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Workout Plan Created.create': {
    roles: ['owner', 'trainer'],
    key: 'workout_plan_created',
    tenantPath: [],
    userPath: [],
  },
  'Member Milestone Achieved.update': {
    roles: ['owner', 'trainer'],
    key: 'member_milestone_achieved',
    tenantPath: [],
    userPath: [],
  },
  'Trainer Performance Updated.update': {
    roles: ['owner'],
    key: 'trainer_performance_updated',
    tenantPath: [],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['owner', 'trainer', 'member'];
