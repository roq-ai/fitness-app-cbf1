  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience Fitness App - Your ultimate platform for planning workout routines, tracking your progress, and sharing routines with others. Includes a comprehensive exercise database and a library of pre-created workouts."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1627483297886-49710ae1fc22?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MXwxfHNlYXJjaHwxfHxmaXRuZXNzfGVufDB8fHx8MTY5NTI5NjYxOHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience Fitness App - Your ultimate platform for planning workout routines, tracking your progress, and sharing routines with others. Includes a comprehensive exercise database and a library of pre-created workouts.`}
            </Text>
            <Box
