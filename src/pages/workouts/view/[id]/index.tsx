...
import { SharedWorkoutListPage } from 'pages/shared-workouts';
import { WorkoutExerciseListPage } from 'pages/workout-exercises';
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('workout', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/workouts/edit/${id}`} passHref legacyBehavior>
                    <Button
