...
import { getWorkoutExerciseById } from 'apiSdk/workout-exercises';
import { WorkoutExerciseInterface } from 'interfaces/workout-exercise';

function WorkoutExerciseViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Workout Exercise Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('workout_exercise', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/workout-exercises/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Reps" text={data?.reps} />

                <FormListItem label="Sets" text={data?.sets} />
                ...
                {hasAccess('exercise', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Exercise"
                    text={
                      <Link as={NextLink} href={`/exercises/view/${data?.exercise?.id}`}>
                        {data?.exercise?.name}
                      </Link>
                    }
                  />
